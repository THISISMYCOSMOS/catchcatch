alter table public.analyses
  drop constraint analyses_status_chk;

alter table public.analyses
  add constraint analyses_status_chk
    check (status in (
      'PENDING',
      'READY_FOR_JUDGMENT',
      'FAILED',
...
alter table public.price_history
  drop constraint price_history_analysis_id_fkey,
  add constraint price_history_analysis_id_fkey
