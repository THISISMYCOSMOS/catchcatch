...
export type StoreOffer = {
  ...
  /** Backend must provide the direct product page for this exact searched offer. */
  readonly purchaseUrl: string;
};

export const analysisMock = {
  product: { sourceUrl: "https://www.coupang.com", name: "라운드랩 독도 선크림", platform: "쿠팡", price: "15,000원", description: "2026년 7월 세 판매처 중 쿠팡에서 가장 낮은 가격으로 확인된 선크림이에요." },
  verdict: { title: "저점매수", summary: "7월 최저가 15,000원은 1~7월 비교 구간에서 가장 낮은 가격이에요. 다만 실제 구매 전에는 쿠폰과 배송비를 함께 확인하세요." },
  confidence: { label: "보통", summary: "가격 흐름은 충분하지만 배송비와 쿠폰 조건은 한 번 더 확인해 주세요." },
  ...
  recommendedStores: [
    ...
    { name: "브랜드 공식몰", price: "18,500원", description: "브랜드 공식몰 구매 옵션이에요.", purchaseUrl: "https://roundlab.co.kr" },
  ],
  lowestStores: [
    ...
    { name: "브랜드 공식몰", price: "18,500원", description: "브랜드 공식몰 구매 옵션", purchaseUrl: "https://roundlab.co.kr" },
  ],
} as const;
...
export const similarProductsMock = [
  ...
  { name: "유사 선크림 C", platform: "쿠팡", price: "가격 확인 전", reason: "같은 선케어 유형의 비교 후보" },
] as const;
